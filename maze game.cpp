...
struct maze *push(struct maze *top,int x,int y,char a[row][col])
{
struct maze *n;
...
struct maze *pop(struct maze *top,char a[row][col])
{
...
{   
    ...
    //a[1][0]=a[1][6]=a[3][7]=a[3][4]=a[4][1]=a[4][6]=a[6][3]=a[6][6]='X';
...
//cout<<p<<"\t"<<q;
        ...
        {   if(u->x-1<0 || user_matrix[u->x-1][u->y]=='X' || a[u->x-1][u->y]==' ')
                {   life=life-1;
                    score=score-5;
                    cout<<"\nyou hit a an invalid location point are deducted";
                ...
                {
                    cout<<"\nno change in point don't act smart!";
                    u->x=u->x-1;
                    user_matrix[u->x][u->y]='@';
                }
                ...
                {   life=life-1;
                    score=score-1;
                    cout<<"\nprobably wrong path and points deducted ";
                    u->x=u->x-1;
                    user_matrix[u->x][u->y]='@';
                }
                else if(a[u->x-1][u->y]=='*')
                ...
                if(coords=='s')
        {
                ...
                {   life=life-1;
                    score=score-5;
                    cout<<"you hit a an invalid location point are deducted";
                }
                else if(u->x+1==p && u->y==q)
                {
                    score = score+2;
                ...
                {
                    cout<<"no change in points don't act smart!";
                    u->x=u->x+1;
                    user_matrix[u->x][u->y]='@';
                }
                else if(a[u->x+1][u->y]=='$')
                {   life=life-1;
                    score=score-1;
                    cout<<"probably wrong path and points deducted ";
                    u->x=u->x+1;
                    user_matrix[u->x][u->y]='@';
                }
        ...
        {    if(u->y-1<0 || user_matrix[u->x][u->y-1]=='X' || a[u->x][u->y-1]==' ')
                ...
                {
                    cout<<"no change in point don't act smart!";
                    u->y=u->y-1;
                    user_matrix[u->x][u->y]='@';
                }
                else if(a[u->x][u->y-1]=='$')
        ...
        if(coords=='d')
        {
                ...
                {   life=life-1;
                    score = score-5;
                    cout<<"you hit a an invalid location point";
                }
                else if(u->x==p && u->y+1==q)
                {
                    score=score+2;
...
int mazewithstacks(struct coords c,char a[row][col],struct maze *top)
{   int f=0;
int k=1;
    while(1)
        {
...
void stackImplementation(struct coords c,char a[row][col],char user_matrix[row][col],struct maze *top,int p,int q)
{
